...
export function quantum_sketch(
  p: p5,
  particleList: QuantumParticle[],
  endList: QuantumParticle[]
) {
  ...
  particleList.forEach((particle) => {
    ...
    if (particle.checkObstacle(650, 350)) {
      if (!particle.checkFlipped()) {
        //particle from left path
...
export function probability_sketch(
  p: p5,
